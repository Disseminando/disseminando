...
if (isset($_POST['ac_login'])) {
  ...
  $MM_redirectLoginSuccess = "./administracao/painelControle.php";
...
<div class="row">
	...
	<div class="c9">
		<div class="leftsidebar">
			...
			<input type="text" name="ac_login" placeholder="Usuário" maxlength="20">
			<input type="password" name="ac_senha" placeholder="Senha" maxlength="20">
