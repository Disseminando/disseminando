...
<div class="grid">
		...
		<div class="row">
				<h1 class="maintitle space-top"><span>COMPARTILHANDO CONHECIMENTO</span></h1>
					...
					<br>
					  <div id="fb-root"></div>
						<script>(function(d, s, id) {
						 ...
						 <center>
						<div class="fb-comments" data-href="http://disseminando.com/escolaBiblica02.php?msg_id<?php echo $row_ls_msgebd['msg_id'];?> data-width="450" data-numposts="5"></div>
						</center>  
                </div>
            </div>
