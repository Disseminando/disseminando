...
<div class="grid">
  ...
  <div class="row"> 
    ...
    <!-- MAIN CONTENT -->
    <div class="c9"><br />
      <h1 class="maintitle space-top"> <span>CONSULTA DESPESAS</span></h1>
      <hr class="hrtitle">        
        <div id="conteudo">
        <form name="form1" method="post" action="fin_resultados.php">
          <table width="100%" border="1" cellspacing="10" cellpadding="10">
            <tr>
              <th scope="col">Inicio:<span id="sprytextfield1">
              <input name="inicio" type="text" size="5">
              <span class="textfieldRequiredMsg">Um valor é necessário.</span><span class="textfieldInvalidFormatMsg">Formato inválido.</span></span></th>
              <th scope="col">Final:
                <label for="final"></label>
                <span id="sprytextfield2">
                <input name="final" type="text" id="final" size="5">
                <span class="textfieldRequiredMsg">Um valor é necessário.</span><span class="textfieldInvalidFormatMsg">Formato inválido.</span></span></th>
            </tr>
          </table>
          <br>
          <input name="enviar" type="submit" class="success" id="enviar" value="Enviar">
        </form>
        <br>
      </div>        
    </div>
