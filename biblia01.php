...
<div class="undermenuarea">
	...
	<div class="grid">
		<div class="row">
			<div class="c8">
				<h1 class="titlehead">Vagas - Estou precisando</h1>
			</div>			
		</div>
	</div>
</div>
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'pt', layout: google.translate.TranslateElement.InlineLayout.SIMPLE, gaTrack: true, gaId: 'UA-72548584-1'}, 'google_translate_element');
		...
		<br>
		<br>
					<img src="images/perseguidos05.png" alt="">					
				</div>
			</div><!-- end sidebar -->
			...
			<div class="c9">
				<h1 class="maintitle space-top">
			  	...
			  	<p>
			      <left>
                     <iframe name="bibliaonline" frameborder="0" src="http://www.novageracao.org/biblia" width="100%" height="350px"></iframe>
                 </left>
				</p>				
		  </div>
          <!-- end main content -->	
