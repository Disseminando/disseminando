...
if(isset($_FILES['msg_foto'])){
	...
	$sql_code= "UPDATE mensagem SET msg_data='$data', msg_categoria='$categoria', msg_titulo='$titulo', msg_texto='$mensagem', msg_situacao='$situacao', msg_foto='$nome_final', msg_diretorio='$diretorio', msg_cadastrador='$autor' WHERE msg_id='$id'";	
