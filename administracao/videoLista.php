...
$query_ls_videos = "SELECT vid_id, vid_data, vid_codigo, vid_categoria, vid_situacao, vid_usuario, vid_cat_id, vid_cat_tipo, sit_cad_id, sit_cad_nome FROM videos, video_categoria, situacao_cadastro WHERE vid_categoria=vid_cat_id AND vid_situacao=sit_cad_id ORDER BY vid_id DESC";
...
<div class="undermenuarea">
  ...
  <div class="grid">
    <div class="row">
      <div class="c8">
        <h1 class="titlehead">Consulta Videos</h1>
      </div>
      <div class="c4">
...
<div class="grid">
  ...
  <div class="row"> 
    ...
    <!-- end sidebar --> 
	<div class="c9"><h1 class="maintitle space-top"><span>Videos</span></h1></div>	
    <div class="container"> 
	   <div class="table-responsive"> 
        <table class="table">
		<thead>
        <tr>
          <td width="18%" align="center" bgcolor="#CCCCCC"><strong>Imagem</strong></td>
          <td width="18%" align="center" bgcolor="#CCCCCC"><strong>Categoria</strong></td>
          <td width="15%" align="center" bgcolor="#CCCCCC"><strong>Situação</strong></td>
        </tr>
		</thead>
		<tbody>
        <?php do { ?>
          <tr>           
                ...
                <td><?php echo $row_ls_videos['vid_codigo']; ?></td>
                <td><?php echo $row_ls_videos['vid_cat_tipo']; ?></td>
                <td><a href="videoAtualiza.php?vid_id=<?php echo $row_ls_videos['vid_id']; ?>"><?php echo $row_ls_videos['sit_cad_nome']; ?></a></td>
