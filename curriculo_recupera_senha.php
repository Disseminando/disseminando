...
<div class="grid">
		...
		<div class="row">		
			...
			<div class="c9">
                ...
                <form class="form-horizontal" method="POST" action="gerar_nova_senha.php" name="recupera">
                <div class="form-group">
                  <div class="col-sm-10">          
                    <input name="email" type="text" class="form-control" id="email" maxlength="100" placeholder="Informe seu Email">
                    <input name="recupera" type="hidden" id="recupera" value="recupera" />
                  </div>
                </div>             
                <input name="Submit" type="submit" class="button" value="Gerar Senha" />                
                </form>                
              </div>	
			<!-- SIDEBAR -->	
			<div class="c3">
